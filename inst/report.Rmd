...
Options selected:
* Drop SNPs: __`r params$dropsnps`__
* Drop CpHs: __`r params$dropcphs`__

Moreover, we also removed SNP loci and/or CpHs if these options are selected:
...
CpGs in heatmap:  __`r if(is.null(nrow(params$filteredlist2heatmap))) "None" else nrow(params$filteredlist2heatmap)`__ 
